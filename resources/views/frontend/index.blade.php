            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <a href="{{ $data->link_iklan }}" class="d-block w-100 text-white text-decoration-none mb-3" ><img class="img-fluid w-100" src="{{ url('gambar_iklan/'.$data->gambar_iklan) }}" alt=""></a>
                        @endforeach
                    </div>
