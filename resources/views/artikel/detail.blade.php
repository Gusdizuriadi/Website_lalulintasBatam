        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <img src="{{ url('gambar_artikel/'.$artikel->gambar_artikel) }}" class="product-image" alt="Product Image">
                    </div>
                </div>
                <div class="col-12 col-sm-6">
            ...
            <div class="row mt-4">
                ...
                <div class="tab-content p-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                        aria-labelledby="product-desc-tab" style="text-align: justify;"> {{ $artikel->deskripsi_artikel }}
                    </div>
            </div>
        </div>
        <!-- /.card-body -->
